...
function WhatsAppButton() {
  // WhatsApp-Nummer (ersetze mit deiner Nummer)
  const phoneNumber = '4917630339020'; // Format: Ländercode ohne +
  const message = 'Hallo! Ich möchte mein Auto verkaufen.';
  ...
  return (
    <a
      ...
      aria-label="WhatsApp - Direkt verkaufen"
    >
      <svg
      ...
      <span className="whatsapp-text">Direkt verkaufen</span>
    </a>
  );
}
